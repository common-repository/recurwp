                    ...
                    if ( $subsections ) {
                        ...
                        while ( $doLoop ) {
                            ...
                            if ( count( $sections ) < $nextK || ! isset ( $sections[ $nextK ] ) || ! isset ( $sections[ $nextK ]['subsection'] ) || $sections[ $nextK ]['subsection'] != true ) {
                                ...
                                $nex_title = "";
                                if(!empty($sections[ $nextK ]['title'])){
                                    $nex_title = wp_kses_post($sections[ $nextK ]['title']);
                                }
                                ...
                                $string .= '<a href="javascript:void(0);" id="' . esc_attr( $nextK . $suffix ) . '_section_group_li_a" class="redux-group-tab-link-a" data-key="' . esc_attr( $nextK ) . '" data-rel="' . esc_attr( $nextK . $suffix ) . '">' . $icon . '<span class="group_title">' .  $nex_title . '</span></a>';
                                $string .= '</li>';
                            }
                        }
