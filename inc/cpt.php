...
*/
/*
Will be added in the future updates.. sorry :) 
...
function subscriptions_post_type() {
	...
	$labels = array(
		...
		'name_admin_bar'        => __( 'Subscriptions', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'Subscription', 'text_domain' ),
		'description'           => __( 'All the subscriptions will be listed here', 'text_domain' ),
		'labels'                => $labels,
